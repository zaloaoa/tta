...
import es.tta.guztiokeuskarapp.example.presentation.DataVerParistik;


public class VerParistikActivity extends AppCompatActivity {
    private DataVerParistik verparistik;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textWording.setText(cancionparistik.getWording());
        bideo=cancionparistik.getVideo();
        layout = (LinearLayout) findViewById(R.id.verparistik);


    }
    public void vercancionparistik(View view) throws IOException {
