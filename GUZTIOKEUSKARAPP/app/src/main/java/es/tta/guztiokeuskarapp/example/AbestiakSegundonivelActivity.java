...
public class AbestiakSegundonivelActivity extends AppCompatActivity implements View.OnClickListener {
    private int correct;
   private DataAbestiakniveldos data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TestAbestiakniveldos test=data.getTest();

        TextView textView=(TextView)findViewById(R.id.testabestiakdos_wording);
        textView.setText(test.getWording());
        RadioGroup radioGroup=(RadioGroup)findViewById(R.id.test_choices_abe_dos);
        int i=0;

        for(TestAbestiakniveldos.Choice choice:test.getChoices()){
    ...
    public void send (View view){
        RadioGroup group = (RadioGroup) findViewById(R.id.test_choices_abe_dos);
    ...
    public void next(View view){
        ...
        intent.putExtra(NivelesAbestiakActivity.EXTRA_DATA_ABE_DOS, data);
